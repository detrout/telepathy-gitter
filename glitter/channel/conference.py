...
__all__ = ['GlitterConferenceChannel']

logger = logging.getLogger('Glitter.ConferenceChannel')

from telepathy.interfaces import CHANNEL_INTERFACE_CONFERENCE

class GlitterConferenceChannel(
        GlitterMucChannel,
        telepathy.server.ChannelInterfaceConference):

    def __init__(self, conn, manager, conversation, props, object_path=None):
        GlitterMucChannel.__init__(self, conn, manager, conversation, props, object_path)
